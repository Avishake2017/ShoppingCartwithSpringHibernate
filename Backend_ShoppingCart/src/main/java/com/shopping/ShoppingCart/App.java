...
public class App 
{
    public static void main(String[] args )
    {
    	...
    	ApplicationContext context = new FileSystemXmlApplicationContext("C:\\Users\\avishake.dutta\\git\\DEmo\\Backend_ShoppingCart\\src\\main\\java\\springs.xml");
    	ProductDao pd=context.getBean("productDao",ProductDao.class);
      
    	Category category = new Category();
    	category.setCategoryName("Electronics");
    	category.setCategoryDescription("Electronic Products");
       
       Product product  = new Product();
       product.setProductName("Refrigerator");
       product.setProductDescription("Electronic Item");
